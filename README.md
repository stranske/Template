...
| `KEEPALIVE_APP_ID` | GitHub App ID | Use with APP_PRIVATE_KEY |
| `KEEPALIVE_APP_PRIVATE_KEY` | GitHub App private key | Use with APP_ID |
...
Legacy workflows may still reference `WORKFLOWS_APP_ID` and `WORKFLOWS_APP_PRIVATE_KEY`; keep them mirrored until workflows are updated.
